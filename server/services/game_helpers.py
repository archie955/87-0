...
async def validate_game(
    ...
    skip = False
    if player_1.team_id != active_game.team_1_id or (
        skip and player_1.team_id != active_game.team_2_id
    ):
        raise InvalidGameLineup()

    if player_2.team_id != active_game.team_2_id or (
        skip and player_2.team_id != active_game.team_3_id
    ):
        raise InvalidGameLineup()

    if player_3.team_id != active_game.team_3_id or (
        skip and player_3.team_id != active_game.team_4_id
    ):
        raise InvalidGameLineup()

    if player_4.team_id != active_game.team_4_id or (
        skip and player_4.team_id != active_game.team_5_id
    ):
        raise InvalidGameLineup()

    if player_5.team_id != active_game.team_5_id or (
